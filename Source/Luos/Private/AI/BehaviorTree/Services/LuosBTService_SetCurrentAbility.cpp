...
#include UE_INLINE_GENERATED_CPP_BY_NAME(LuosBTService_SetCurrentAbility)

ULuosBTService_SetCurrentAbility::ULuosBTService_SetCurrentAbility()
{
...
void ULuosBTService_SetCurrentAbility::OnBecomeRelevant(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
...
void ULuosBTService_SetCurrentAbility::TickNode(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds)
{
