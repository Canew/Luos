...
#include UE_INLINE_GENERATED_CPP_BY_NAME(LuosBTTask_TurnTo)

ULuosBTTask_TurnTo::ULuosBTTask_TurnTo()
{
	...
	BlackboardKey.AddObjectFilter(this, GET_MEMBER_NAME_CHECKED(ULuosBTTask_TurnTo, BlackboardKey), AActor::StaticClass());
	BlackboardKey.AddVectorFilter(this, GET_MEMBER_NAME_CHECKED(ULuosBTTask_TurnTo, BlackboardKey));
}

FString ULuosBTTask_TurnTo::GetNodeName_Implementation() const
{
	return FString(TEXT("Turn To"));
}

EBTNodeResult::Type ULuosBTTask_TurnTo::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
...
FString ULuosBTTask_TurnTo::GetStaticDescription() const
{
