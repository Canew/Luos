...
#include "LuosBTTask_TryActivateAbility.generated.h"

/**
 * 
 */
UCLASS()
class LUOS_API ULuosBTTask_TryActivateAbility : public UBTTask_BlackboardBase
{
	GENERATED_BODY()
	
public:
	ULuosBTTask_TryActivateAbility();
