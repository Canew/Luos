...
#include "LuosBTDecorator_CanActivateAbility.generated.h"
 ...
 */
UCLASS()
class LUOS_API ULuosBTDecorator_CanActivateAbility : public UBTDecorator_BlackboardBase
{
	GENERATED_BODY()
	
public:
	ULuosBTDecorator_CanActivateAbility();
